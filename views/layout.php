			...
			<div class="row-fluid main-container">
				<div class="span1">
					<ul class="nav">
						...
						<li class="hint--right" data-hint="Recommendations"><div class="wrapper-dropdown-2"><a href="/recommendations"><i class="fa fa-star fa-lg"></i></a></div></li>
						...
						<li class="hint--right" data-hint="Insights"><div class="wrapper-dropdown-2"><a href="/insights"><i class="fa fa-eye fa-lg"></i></a></div></li>
						<li class="hint--right" data-hint="About"><div class="wrapper-dropdown-2"><a href="/about">&nbsp;<i class="fa fa-question fa-lg"></i></a></div></li>
						<li class="hint--right" data-hint="Contact Us"><div class="wrapper-dropdown-2"><a href="/contact">&nbsp;<i class="fa fa-envelope"></i></a></div></li>
					</ul>
				</div>
				<div class="span11">
					<?php echo $content; ?>
